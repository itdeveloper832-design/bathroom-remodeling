...
export const metadata: Metadata = {title: "Bath Remodel Downtown Chandler | Licensed Pro | ARZ Chandl",description: "Top-rated bathroom remodeling in Downtown Chandler by ARZ. Specialized in custom walk-in showers, tub conversions, & tile work. Call for a free quote!",
