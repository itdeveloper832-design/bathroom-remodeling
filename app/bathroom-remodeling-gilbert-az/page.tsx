...
export const metadata: Metadata = {
  ...
  description:
    "Hire the top-rated bathroom remodeling company in Gilbert, AZ. We specialize in master bathroom renovations, shower replacements, and tub-to-shower conversions. Licensed company, free estimates — call (229) 306-5591 today!",
  keywords: [
    "bathroom remodeling Gilbert AZ",
    "bathroom remodel Gilbert Arizona",
    "bathroom renovation Gilbert AZ",
    "shower remodeling Gilbert AZ",
    "tub to shower conversion Gilbert AZ",
    "master bathroom renovation Gilbert AZ",
    "licensed bathroom contractor Gilbert AZ",
    "bathroom remodel cost Gilbert AZ",
    "Morrison Ranch bathroom remodel",
    "Power Ranch bathroom remodeling",
    "Val Vista Lakes bathroom remodelers",
    "bathroom contractor 85234",
    "bathroom contractor 85295",
    "bathroom contractor 85296",
    "bathroom contractor 85297",
    "bathroom contractor 85298",
  ],
  openGraph: {
