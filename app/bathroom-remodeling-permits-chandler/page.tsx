          ...
          <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
            ...
            <div className="flex items-start gap-3 bg-secondary border border-border rounded-xl p-5 mt-6">
              ...
              <p className="text-sm text-muted-foreground">
                As a licensed contractor (<strong className="text-foreground">ROC338304</strong>), ARZ Home Remodeling handles the entire permit process. We prepare the design drawings, submit documentation to the City of Chandler, and host inspectors at your home. Call us at <a href="tel:+14805693339" className="text-primary hover:underline font-medium">(480) 569-3339</a> to discuss your plans.
              </p>
            </div>
          </div>
        </section>
