                    ...
                    <Link href={`/blog/${featuredPost.slug}/`} className="group block">
                      <div className="grid md:grid-cols-2 gap-8 items-center">
                        ...
                        <div>
                          ...
                          <h2 className="mt-3 text-2xl md:text-3xl font-serif font-semibold text-foreground group-hover:text-primary transition-colors text-balance leading-tight">
                            {featuredPost.title}
                          </h2>
                  ...
                  {remainingPosts.map((post, index) => (
                    ...
                    >
                      <Link href={`/blog/${post.slug}/`} className="group block">
                        <div className="relative aspect-[16/10] overflow-hidden rounded-xl mb-4 shadow-sm group-hover:shadow-md transition-shadow">
                          <Image
                        ...
                        <h3 className="mt-2 text-xl font-serif font-semibold text-foreground group-hover:text-primary transition-colors text-balance leading-tight">
                          {post.title}
                        </h3>
