...
export const metadata: Metadata = {title: "Blog Chandler AZ | Free Estimate",description: "Professional blog in Chandler, AZ. Quality craftsmanship, honest pricing, and free estimates. Call today.",
