            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  ...
                  <p>
                    Today's homeowners are changing how they use their spaces. The daily ritual of a luxurious, expansive shower has completely replaced the occasional soak in a garden tub. That is why ARZ Home Remodeling specializes in reclaiming that wasted square footage. We are experts at safely demolishing old layouts, tearing out those bulky tubs, and installing expansive, open-concept walk-in showers. By updating your bathroom with local, high-quality porcelain slabs, frameless glass enclosures, and modern fixtures, we breathe entirely new life into your master suite.
                  </p>
                  <p>
