...
export const metadata: Metadata = {
  ...
  description: "Learn about ARZ Home Remodeling's comprehensive 5-Year Workmanship Warranty for custom tile showers and bathroom renovations in Chandler, AZ.",
  openGraph: {
