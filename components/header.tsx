    ...
    <header className="sticky top-0 z-50 bg-white shadow-sm border-b border-slate-200">
      <nav className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a href="tel:2293065591" className="flex items-center gap-2 bg-blue-950 text-white px-4 py-2 rounded">
            <Phone size={16} />
            <span>Call Now</span>
          </a>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-t border-slate-200 px-4 py-4 space-y-4">
          ...
          <a href="tel:2293065591" className="flex items-center gap-2 bg-blue-950 text-white px-4 py-2 rounded w-fit">
            <Phone size={16} />
            Call Now
          </a>
        </div>
