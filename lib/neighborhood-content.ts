...
> = {
  ocotillo: {
    hero: "Luxury bathroom remodeling for Ocotillo's exclusive resort living",
    keyPoint1: "Premium fixtures and finishes that match Ocotillo's upscale aesthetic",
    keyPoint2: "Spa style designs perfect for Ocotillo's desert luxury lifestyle",
  ...
  "fulton-ranch": {
    ...
    keyPoint1: "Aging in place design customized for Fulton Ranch's mature demographic",
  ...
  "circle-g": {
    ...
    keyPoint1: "Modern fixtures and smart bathroom technology for technology professionals",
  ...
  "riggs-ranch": {
    ...
    keyPoint3: "Maximizing standard builder grade to premium bathroom upgrades",
    faqTopics: [
      "What bathroom upgrades are best for new construction homes?",
      "How can I personalize my new Riggs Ranch home's bathroom?",
      "What's included in a typical basic builder bathroom?",
  ...
  "downtown-chandler": {
    ...
    keyPoint2: "Trendy, highly attractive designs that reflect city living",
    ...
    faqTopics: [
      ...
      "How do I design a beautiful urban bathroom?",
  ...
  "stellar-airpark": {
    ...
    keyPoint1: "Custom bathroom experiences reflecting Stellar Airpark's unique lifestyle",
  ...
  "chandler-heights": {
    hero: "High-end home and bathroom remodeling for custom Chandler Heights properties",
    keyPoint1: "Tailored custom remodeling for spacious desert acreage estates",
    keyPoint2: "Stain-resistant materials built to resist high mineral hard water",
    keyPoint3: "Turnkey design-build updates fully code-compliant with local guides",
    faqTopics: [
      "How does hard water affect my new bathroom fixtures?",
      "Do I need City of Chandler or Maricopa County building permits?",
      "Can you expand compact bathroom layout floor plans?",
      "What home improvements have the best ROI in Chandler Heights?",
    ],
  },
  "andersen-springs": {
    hero: "High-end home and bathroom remodeling for custom Andersen Springs properties",
    keyPoint1: "Tailored custom remodeling for lakeside master-planned properties",
    keyPoint2: "Stain-resistant materials built to resist high mineral hard water",
    keyPoint3: "Turnkey design-build updates fully code-compliant with local guides",
    faqTopics: [
      "How does hard water affect my new bathroom fixtures?",
      "Do I need City of Chandler building permits for a remodel?",
      "Can you expand compact bathroom layout floor plans?",
      "What home improvements have the best ROI in Andersen Springs?",
    ],
  },
  "layton-lakes": {
    hero: "High-end home and bathroom remodeling for custom Layton Lakes properties",
    keyPoint1: "Tailored custom remodeling for lakeside master-planned properties",
    keyPoint2: "Stain-resistant materials built to resist high mineral hard water",
    keyPoint3: "Turnkey design-build updates fully code-compliant with local guides",
    faqTopics: [
      "How does hard water affect my new bathroom fixtures?",
      "Do I need City of Chandler or Town of Gilbert permits?",
      "Can you expand compact bathroom layout floor plans?",
      "What home improvements have the best ROI in Layton Lakes?",
    ],
  },
  "the-islands": {
    hero: "High-end home and bathroom remodeling for custom The Islands properties",
    keyPoint1: "Tailored custom remodeling for waterfront master-planned properties",
    keyPoint2: "Stain-resistant materials built to resist high mineral hard water",
    keyPoint3: "Turnkey design-build updates fully code-compliant with local guides",
    faqTopics: [
      "How does hard water affect my new bathroom fixtures?",
      "Do I need City of Chandler building permits for a remodel?",
      "Can you expand compact bathroom layout floor plans?",
      "What home improvements have the best ROI in The Islands?",
    ],
  },
  "pecos-ranch": {
    hero: "High-end home and bathroom remodeling for custom Pecos Ranch properties",
    keyPoint1: "Tailored custom remodeling for lakeside master-planned properties",
    keyPoint2: "Stain-resistant materials built to resist high mineral hard water",
    keyPoint3: "Turnkey design-build updates fully code-compliant with local guides",
    faqTopics: [
      ...
      "Do I need City of Chandler building permits for a remodel?",
      "Can you expand compact bathroom layout floor plans?",
      "What home improvements have the best ROI in Pecos Ranch?",
    ],
  },
};
