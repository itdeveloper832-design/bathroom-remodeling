...
export const serviceContent: Record<string, ServiceContentData> = {
  ...
  "kitchen-remodeling": {
    benefits: [
      {
        title: "Modern Gourmet Kitchens",
        description: "Custom layouts designed for cooking efficiency, entertaining, and maximum storage.",
        icon: "ChefHat",
      },
      {
        title: "Premium Countertop Upgrades",
        description: "Stunning quartz, granite, and marble surfaces that resist heat, stains, and scratches.",
        icon: "Sparkles",
      },
      {
        title: "Custom Cabinetry & Storage",
        description: "Soft-close cabinets, pull-out organizers, and walk-in pantries tailored to your habits.",
        icon: "Box",
      },
      {
        title: "Increased Home Equity",
        description: "Kitchen remodels offer one of the highest returns on investment for Chandler homeowners.",
        icon: "TrendingUp",
      },
    ],
    issues: [
      {
        problem: "Outdated builder-grade cabinets and peeling laminate countertops",
        solution: "Full cabinet replacement or professional refinishing with premium stone countertops.",
      },
      {
        problem: "Cramped 'Work Triangle' making cooking difficult and stressful",
        solution: "Strategic layout reconfiguration to optimize the flow between sink, stove, and fridge.",
      },
      {
        problem: "Inadequate lighting over prep areas and islands",
        solution: "Integrated under-cabinet LEDs, pendant lights, and recessed task lighting design.",
      },
      {
        problem: "Lack of functional storage leading to cluttered countertops",
        solution: "Custom pull-outs, spice racks, and deep drawers designed for modern kitchen gadgets.",
      },
    ],
    tips: [
      "Prioritize Quartz for Durability: It's non-porous and never needs sealing—perfect for busy Chandler kitchens.",
      "Invest in Layered Lighting: Combine task, ambient, and accent lighting for a functional and beautiful kitchen.",
      "Plan for Extra Outlets: Include pop-up or hidden outlets in islands and prep stations for small appliances.",
      "Don't Forget the Backsplash: It's the best way to add personality and protect your walls from cooking splatters.",
    ],
    faqs: [
      {
        question: "How much does a kitchen remodel cost in Chandler, AZ?",
        answer:
          "A minor kitchen update ranges from $12,000–$25,000. A full mid-range remodel typically costs $25,000–$50,000. Luxury gourmet kitchens can range from $50,000–$100,000+. We provide free itemized quotes.",
      },
      {
        question: "How long does a kitchen remodel typically take?",
        answer:
          "A full kitchen renovation in Chandler usually takes 4–8 weeks. Partial remodels (cabinets/counters only) can be finished in 2–3 weeks. We provide a firm written schedule.",
      },
      {
        question: "Do you handle plumbing and electrical for kitchens?",
        answer:
          "Yes. We are full-service licensed contractors. We handle all plumbing, electrical, gas lines, and venting required for your kitchen project.",
      },
      {
        question: "Can I stay in my home during a kitchen remodel?",
        answer:
          "Most homeowners stay in their homes. We set up a 'temporary kitchen' area and ensure daily cleanup to minimize disruption to your family life.",
      },
      {
        question: "Do you offer financing for kitchen remodeling?",
        answer:
          "Yes! We offer flexible financing options for qualified Chandler homeowners to help you build your dream kitchen now and pay over time.",
      },
    ],
  },
